...
public class Spielbrett {
	...
	/**
	 * Pr�ft, ob in einem Zug andere Kugeln verschoben werden k�nnen
	 * @param Die Felder, von denen gezogen wird 
	 * @param Die Richtung, in die gezogen wird
	 * @return True oder False, abh�ngig davon, ob eine andere Kugel verschoben 
	 * werden kann
	 */
...
//							return "R-2Z1ABR"; // 2 zu 1 Abr�umer
//							 
//						}
//						else {
...
//						Spielfeld gegnerStein = vordersterStein.getNachbar(richtung);
//						if(wirdAbgeraeumt(gegnerStein, richtung)) {
//							return "R-3Z1ABR"; // 3 zu 1 Abr�umer
//						}
//
//						else {
...
//	}
	...
	/**
	 * Prueft, ob es sich bei einem regul�ren Zug um einen Zug handelt, 
	...
	public Spielzug formatieren(Spielzug zug) {
		...
		if(von.length() == 4) {
			...
			if(feld1.hatNachbar(ziel)) {
				int richtung = feld1.getNachbarId(ziel);
				Spielfeld zielNachFormatierung = feld2.getNachbar(richtung);
				Spielzug formatierterZug = new Spielzug(feld1.getId()+ feld2.getId(), zielNachFormatierung.getId(), richtung, feld1.getFarbe());
				return formatierterZug;
			}
		}
		return zug;
	}
	...
	/**
	 * Pr�ft, ob ein Zwei-zu-eins Sumito m�glich ist.
	 ...
	 * @return true, wenn m�glich, false, wenn nicht m�glich.
	 */
	...
	/**
	 * Pr�ft, ob ein Zwei-zu-drei Sumito m�glich ist.
	 * @param vordersterStein der vorderste Stein eines Spielzuges in dem 
	...
	/**
	 * Gibt f�r einen Zug aus 2 oder 3 Steinen, bei dem eigene Steine geschoben 
	 * werden, die Position des hintersten Steines in Richtung des Zuges zur�ck.
	 * @param felder ein Spielfeld-Array
